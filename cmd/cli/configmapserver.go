...
// NewConfigMapServerCmd returns the appregistry-server command
func NewConfigMapServerCmd() *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "configmap-server",
		...
		RunE: runConfigMapServerCmdFunc,
	}
...
func runConfigMapServerCmdFunc(cmd *cobra.Command, args []string) error {
...
// NewClientFromConfig creates a kubernetes client or bails out on on failures.
