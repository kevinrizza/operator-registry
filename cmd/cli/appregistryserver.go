...
// NewAppregistryServerCmd returns the appregistry-server command
func NewAppregistryServerCmd() *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "appregistry-server",
		...
		RunE: runAppregistryServerCmdFunc,
	}
...
func runAppregistryServerCmdFunc(cmd *cobra.Command, args []string) error {
